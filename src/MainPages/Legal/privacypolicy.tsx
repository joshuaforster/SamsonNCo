...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="container mx-auto p-8">
      <Helmet>
        <title>Privacy Policy - Sampson N Co</title>
        <meta name="description" content="Read our Privacy Policy to learn how Sampson N Co collects, uses, and protects your personal information." />
      </Helmet>
      <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">Sampson N Co</h2>
        <p className="mb-2">
          We at Sampson N Co ("we", "us", "our") are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website 
          <a href="https://www.sampsonnco.com" className="text-blue-500"> www.sampsonnco.com</a> or use our services. Please read this Privacy Policy carefully. If you do not agree with the terms of this Privacy Policy, please do not access the site.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="ml-4 mb-2">
          We may disclose your information if we believe it is necessary to comply with applicable laws, regulations, or legal processes, or to protect the rights, property, and safety of Sampson N Co, our customers, or others.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          ...
          <a href="mailto:ganoff@sampsonnco.com" className="text-blue-500"> ganoff@sampsonnco.com</a>.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="ml-4 mb-2">
          Sampson N Co  
          183 St. Leonards Road, Norwich, England, NR1 4JN
          <a href="mailto:ganoff@sampsonnco.com" className="text-blue-500">ganoff@sampsonnco.com</a>
        </p>
      </section>
    </div>
